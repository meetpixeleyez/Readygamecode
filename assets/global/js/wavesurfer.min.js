!(function (t, e) {
  ...
  const o = {
    fetchBlob: function (e, i, s) {
      return t(this, void 0, void 0, function* () {
        ...
        if (n.status >= 400)
          throw new Error(
            `Failed to fetch ${e}: ${n.status} (${n.statusText})`
          );
        return (
          (function (e, i) {
  ...
  class h extends e {
    ...
    initHtml() {
      const t = document.createElement("div"),
        ...
        i =
          this.options.cspNonce && "string" == typeof this.options.cspNonce
    ...
    destroy() {
      ...
      this.subscriptions.forEach((t) => t()),
        ...
        null === (e = this.unsubscribeOnScroll) ||
          void 0 === e ||
          e.forEach((t) => t()),
        (this.unsubscribeOnScroll = []);
    }
      ...
      if ((u(f - 1), u(f), u(f + 1), p > 1)) {
        const t = this.on("scroll", () => {
          const { scrollLeft: t } = this.scrollContainer,
            e = Math.floor((t / l) * p);
          Object.keys(c).length > h.MAX_NODES &&
            ((n.innerHTML = ""), (r.innerHTML = ""), (c = {})),
            u(e - 1),
            u(e),
            u(e + 1);
        });
  ...
  class d extends e {
    ...
    get duration() {
      ...
      return null !== (t = this._duration) && void 0 !== t
        ? t
        : (null === (e = this.buffer) || void 0 === e ? void 0 : e.duration) ||
            0;
    }
    set duration(t) {
      this._duration = t;
  ...
  class u extends a {
    ...
    updateProgress(t = this.getCurrentTime()) {
      return (
        this.renderer.renderProgress(t / this.getDuration(), this.isPlaying()),
        t
      );
    }
    initTimerEvents() {
    ...
    setOptions(t) {
      (this.options = Object.assign({}, this.options, t)),
        t.duration &&
          !t.peaks &&
          (this.decodedData = i.createBuffer(this.exportPeaks(), t.duration)),
        t.peaks &&
          t.duration &&
      ...
      return t(this, void 0, void 0, function* () {
        ...
        if (
          ...
          window.AbortController &&
            ...
            (i.signal =
              null === (t = this.abortController) || void 0 === t
                ? void 0
                : t.signal));

...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  try {
    ...
    return [...staticRoutes, ...categoryUrls, ...productUrls, ...blogUrls, ...authorUrls];
  } catch (error) {
    console.warn("Failed to fetch dynamic entries for sitemap from database, falling back to static routes:", error);
    return staticRoutes;
  }
}
